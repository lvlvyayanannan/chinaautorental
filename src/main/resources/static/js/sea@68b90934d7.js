...
!function (a, b) {
    ...
    if (!a.seajs) {
        var t = a.seajs = {version: "2.3.0"}, u = t.data = {}, v = c("Object"), w = c("String"),
            x = Array.isArray || c("Array"), y = c("Function"), z = 0, A = u.events = {};
        t.on = function (a, b) {
            return (A[a] || (A[a] = [])).push(b), t
        }, t.off = function (a, b) {
        ...
        t.resolve = m;
        var R, S, P = K.head || K.getElementsByTagName("head")[0] || K.documentElement,
        ...
        s.prototype.resolve = function () {
            ...
            if (!(a.status >= $.LOADING)) {
                ...
                var c = a.resolve();
                B("load", c);
                for (var e, d = a._remain = c.length, f = 0; d > f; f++) e = s.get(c[f]), e.status < $.LOADED ? e._waitings[a.uri] = (e._waitings[a.uri] || 0) + 1 : a._remain--;
